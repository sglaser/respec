...
/******/ 		return __webpack_require__.p + "" + chunkId + ".respec-pcisig.js"
/******/ 	}
/******/
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [
  ...
  ], __WEBPACK_AMD_DEFINE_RESULT__ = (function(domReady, runner, ui) {
    ui = ui.ui;
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(10), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _l10n, _pubsubhub) {
  ...
  function getDfnTitles(elem) {
    ...
    if (elem.dataset.lt) {
      ...
      elem.dataset.lt.split("|").map(item => norm(item)).forEach(item => titleSet.add(item));
...
function parseAttributes(node, holes, parts, path) {
  ...
  /* istanbul ignore next */
  var cleanValue = 0 < length && domconstants__WEBPACK_IMPORTED_MODULE_2__["UID_IE"] && !('ownerSVGElement' in node);
  while (i < length) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(46), __webpack_require__(56), __webpack_require__(51), __webpack_require__(55)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _defaults, _dfnMap, _linter, _privsecSection) {
  ...
  function run(conf) {
    ...
    const lint = conf.lint === false ? false : _objectSpread({}, _defaults.coreDefaults.lint, {}, pcisigDefaults.lint, {}, conf.lint);
    Object.assign(conf, _objectSpread({}, _defaults.coreDefaults, {}, pcisigDefaults, {}, conf, {
      lint
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _pubsubhub) {
  ...
  function attachFixupScript(doc, version) {
    ...
    script.src = "https://sglaser.github.io/respec/Spec/scripts/".concat(version, "/fixup.js");
  ...
  function run(conf, doc, cb) {
    ...
    let styleFile = "PCISIG-"; // Figure out which style file to use.
    ...
    const version = selectStyleVersion(conf.useExperimentalStyles || "2017"); // Attach PCISIG fixup script after we are done.
    ...
    const finalStyleURL = "https://sglaser.github.io/respec/Spec/StyleSheets/".concat(finalVersionPath).concat(styleFile, ".css");

    if (conf.cssOverride) {
      (0, _utils.linkCSS)(doc, conf.cssOverride);
    } else {
    ...
    cb();
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=pcisig-style.js.map
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(10)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _l10n) {
  ...
  const name = "pcisig/l10n";
  _exports.name = name;
  const additions = {
    en: {
      status_at_publication: "This section describes the status of this document at the time of its publication. Other documents may supersede this document. A list of current PCISIG publications and the latest revision of this specification can be found at <a href='https://www.pcisig.com'>pcisig.com</a>"
    }
  };
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(64), __webpack_require__(68), __webpack_require__(13), __webpack_require__(3), __webpack_require__(72)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _cgbgHeaders, _headers, _hyperhtml, _pubsubhub, _sotd) {
  "use strict";
  ...
  const specTrackStatus = ["WD", "ED", "RC", "PUB", "FINAL", "WD-CWG", "ED-CWG", "RC-CWG", "PUB-CWG", "WD-MEM", "ED-MEM", "RC-MEM", "PUB-MEM", "WD-FINAL", "ED-FINAL", "RC-FINAL", "PUB-FINAL"]; // Chapters are never published standalone. if conf.specChapter is present,
  ...
  const noTrackStatus = ["unofficial", "private", "base", "note", "draft-note", "member-private", "member-submission", "team-private", "team-submission"];
  ...
  function validateDateAndRecover(conf, prop, fallbackDate = new Date()) {
    ...
    const msg = "[`".concat(prop, "`](https://github.com/pcisig/respec/wiki/").concat(prop, ") ") + "is not a valid date: \"".concat(conf[prop], "\". Expected format 'YYYY-MM-DD'.");
    (0, _pubsubhub.pub)("error", msg);
  ...
  function run(conf) {
    ...
    if (conf.doRDFa === undefined) conf.doRDFa = true; // validate configuration and derive new configuration values
    ...
    if (["cc0", "cc-by"].includes(conf.license)) {
      let msg = "You cannot use license \"".concat(conf.license, "\" with PCISIG Specs. ");
      let non_cc0 = licenses.keys.remove("cc0").remove("cc-by").toString();
      msg += "Please set 'respecConfig.license:' to one of ".concat(non_cc0, " instead.");
      (0, _pubsubhub.pub)("error", msg);
    }
    ...
    conf.publishDate = validateDateAndRecover(conf, "publishDate", doc.lastModified);
    ...
    conf.isSpecTrack = conf.noSpecTrack ? false : specTrackStatus.includes(conf.specStatus);

    if (conf.isSpecTrack && !conf.specRevision) {
      (0, _pubsubhub.pub)("error", "Missing required configuration: `specRevision`");
    }

    if (conf.isSpecTrack && !conf.specDraftLevel) {
      (0, _pubsubhub.pub)("error", "Missing required configuration: `specDraftLevel`");
    }
    ...
    if (conf.isMemberPrivate) {
      ...
      conf.logos.push(_objectSpread({}, baseLogo, {}, memPrivateLogo));
    }
    ...
    if (conf.isTeamPrivate) {
      ...
      conf.logos.push(_objectSpread({}, baseLogo, {}, teamPrivateLogo));
    }
    ...
    if (conf.specStatus === "member-submission") publishSpace = "Spec/Submission";else if (conf.specStatus === "member-private") publishSpace = "Spec/Submission/Private";else if (conf.specStatus === "team-submission") publishSpace = "Spec/TeamSubmission";else if (conf.specStatus === "team-private") publishSpace = "Spec/TeamSubmission/Private";
    if (conf.isRegular) conf.thisVersion = "https://sglaser.github.io/respec/" + publishSpace + "/" + conf.publishDate.getUTCFullYear() + "/" + conf.shortName + "-" + conf.maturity + "-" + (0, _utils.concatDate)(conf.publishDate) + "/";
    if (conf.isRegular) conf.latestVersion = "https://sglaser.github.io/respec/" + publishSpace + "/" + conf.shortName + "/";

    if (conf.previousPublishDate) {
      if (!conf.previousStatus) {
        (0, _pubsubhub.pub)("error", "`previousPublishDate` is set, but not `previousStatus`.");
      }

      if (!conf.previousRevision) {
        (0, _pubsubhub.pub)("error", "`previousPublishDate` is set, but not `previousRevision`.");
      }

      if (!conf.previousDraftLevel) {
        (0, _pubsubhub.pub)("error", "`previousPublishDate` is set, but not `previousDraftLevel`.");
      }
      ...
      if (conf.isBasic) {
        ...
        conf.prevVersion = "https://sglaser.github.io/respec/Spec/" + conf.previousPublishDate.getUTCFullYear() + "/" + conf.shortName + "-" + pmat + "-" + (0, _utils.concatDate)(conf.previousPublishDate) + "/";
      }
    } else {
      if (!/NOTE$/.test(conf.specStatus) && !conf.prevStatus === "none" && !conf.noSpecTrack && !conf.isNoTrack && !conf.isSubmission) (0, _pubsubhub.pub)("error", "Document on specification track but has no previous version:" + " Add `previousStatus`, `previousRevision`, `previousDraftLevel`, and `previousPublishDate` to ReSpec's config.");
    ...
    conf.showPreviousVersion = !conf.previousStatus === "none" && !conf.isNoTrack && !conf.isSubmission;
    ...
    if (conf.isFinal && !conf.errata) (0, _pubsubhub.pub)("error", "Recommendations must have an errata link.");
    conf.isUnofficial = conf.specStatus === "unofficial";
    ...
    conf.shortISODate = _utils.ISODate.format(conf.publishDate); // configuration done - yay!
    // NOTE:

    if (Array.isArray(conf.wg)) {
      conf.multipleWGs = conf.wg.length > 1;
      conf.wgHTML = (0, _utils.joinAnd)(conf.wg);
    } else {
    ...
    let sotd = document.getElementById("sotd") || document.createElement("section");
    ...
    sotd.classList.add("introductory"); // invent toc if not already present
    ...
    let revision_history = document.body.querySelector("#revision-history") || document.createElement("section");

    if (!conf.isNoTrack && !revision_history.id) {
      (0, _pubsubhub.pub)("error", "A Revision History section is required for your type of document.");
    }
    ...
    if (conf.specStatus === "PUB-CWG" && !conf.cwgReviewEnd) {
      (0, _pubsubhub.pub)("error", "'specStatus' is \"PUB-CWG\" but no 'cwgReviewEnd' is specified (needed to indicate end of the Cross Workgroup Review).");
    }
    ...
    if (conf.specStatus === "PUB-MEM" && !conf.memReviewEnd) {
      (0, _pubsubhub.pub)("error", "'specStatus' is \"PUB-MEM\", but no 'memReviewEnd' is specified (needed to indicate end of the Member Review).");
    }

    conf.memReviewEnd = validateDateAndRecover(conf, "memReviewEnd");
    conf.humanMemReviewEnd = PCISIGDate.format(conf.memReviewEnd);

    _hyperhtml.default.bind(sotd)(_templateObject(), populateSoTD(conf, sotd)); // Requested by https://github.com/w3c/respec/issues/504
  ...
  function populateSoTD(conf, sotd) {
    const options = _objectSpread({}, collectSotdContent(sotd, conf), {
      get mailToWGPublicList() {
        return "mailto:".concat(conf.wgPublicList, "@pcisig.org");
      },
      ...
      get mailToWGPublicListSubscription() {
        return "mailto:".concat(conf.wgPublicList, "-request@pcisig.org?subject=subscribe");
      }

    });

    const template = _sotd.default;
  ...
  function isElement(node) {
    return node.nodeType === Node.ELEMENT_NODE;
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=pcisig-headers.js.map
  ...
  var _default = (items = []) => {
    ...
    function getItem(p) {
      ...
      if (p.retiredDate) {
        ...
        timeElem.textContent = isValidDate ? (0, _utils.humanDate)(retiredDate) : "Invalid Date"; // todo: Localise invalid date

        if (!isValidDate) {
          (0, _utils.showInlineError)(timeElem, "The date is invalid. The expected format is YYYY-MM-DD.", "Invalid date");
        }

        timeElem.dateTime = (0, _utils.toShortIsoDate)(retiredDate);
        contents.push((0, _hyperhtml.default)(_templateObject8(), l10n.until.concat(" "), [timeElem]));
      }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(13), __webpack_require__(9), __webpack_require__(3), __webpack_require__(69), __webpack_require__(70), __webpack_require__(71)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _hyperhtml, _utils, _pubsubhub, _showLink, _showLogo, _showPeople) {
  "use strict";
  ...
  function linkLicense(text, url, cssClass) {
    return (0, _hyperhtml.default)(_templateObject17(), url, cssClass, text);
  }

  function renderCopyright(conf) {
    return conf.isUnofficial ? conf.additionalCopyrightHolders ? (0, _hyperhtml.default)(_templateObject18(), [conf.additionalCopyrightHolders]) : conf.overrideCopyright ? [conf.overrideCopyright] : (0, _hyperhtml.default)(_templateObject19(), linkLicense("Creative Commons Attribution 3.0 License", ccLicense, "subfoot")) : conf.overrideCopyright ? [conf.overrideCopyright] : renderOfficialCopyright(conf);
  }

  function renderOfficialCopyright(conf) {
    return (0, _hyperhtml.default)(_templateObject20(), conf.copyrightStart ? "".concat(conf.copyrightStart, "-") : "", conf.publishYear, conf.additionalCopyrightHolders ? (0, _hyperhtml.default)(_templateObject21(), [conf.additionalCopyrightHolders]) : "", noteIfDualLicense(conf), legalDisclaimer, PCISIGTrademark, linkDocumentUse(conf));
  }
  ...
  function noteIfDualLicense(conf) {
    ...
    return (0, _hyperhtml.default)(_templateObject22(), linkLicense("CC-BY", ccLicense), linkLicense("pcisig Document License", pcisigLicense));
  }

  function linkDocumentUse(conf) {
    if (conf.isCCBY) {
      return linkLicense("document use", "https://www.pcisig.com/Consortium/Legal/2013/copyright-documents-dual.html");
    }

    if (conf.ispcisigSoftAndDocLicense) {
      return linkLicense("permissive document license", "https://www.pcisig.com/Consortium/Legal/2015/copyright-software-and-document");
    }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _hyperhtml) {
  ...
  function renderDeliverer(conf) {
    ...
    const wontBeRec = recNotExpected ? "The group does not expect this document to become a PCI-SIG Recommendation." : "";
  ...
  function noteForMemberSubmission(conf) {
    const teamComment = "https://www.pcisig.com/Submission/".concat(conf.publishDate.getUTCFullYear(), "/").concat(conf.submissionCommentNumber, "/Comment/");
    return (0, _hyperhtml.default)(_templateObject24(), conf.thisVersion, teamComment);
  }

  function noteForTeamSubmission(conf, opts) {
    return (0, _hyperhtml.default)(_templateObject25(), opts.mailToWGPublicListWithSubject, conf.wgPublicList, opts.mailToWGPublicListSubscription, "https://lists.pcisig.com/Archives/Public/".concat(conf.wgPublicList, "/"), conf.subjectPrefix ? (0, _hyperhtml.default)(_templateObject26(), conf.subjectPrefix) : "");
  }
  ...
  function linkToWorkingGroup(conf) {
    ...
    return (0, _hyperhtml.default)(_templateObject27(), [conf.wgHTML], conf.anOrA, conf.longStatus, conf.notYetRec ? "This document is intended to become a PCI-SIG Recommendation." : "");
  }
  ...
  function linkToCommunity(conf, opts) {
    ...
    return (0, _hyperhtml.default)(_templateObject28(), conf.github ? (0, _hyperhtml.default)(_templateObject29(), conf.issueBase) : "", conf.wgPublicList ? (0, _hyperhtml.default)(_templateObject30(), conf.github && conf.wgPublicList ? "Alternatively, you can send comments to our mailing list." : "Comments regarding this document are welcome.", opts.mailToWGPublicListWithSubject, conf.wgPublicList, "https://lists.pcisig.com/Archives/Public/".concat(conf.wgPublicList, "/"), conf.subjectPrefix ? (0, _hyperhtml.default)(_templateObject31(), conf.subjectPrefix) : "") : "");
  }
}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(10), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _l10n, _pubsubhub) {
  ...
  _exports.run = run;
  _exports.name = void 0;
  // Module pcisig/abstract
  // Handle the abstract section properly.
  const name = "pcisig/abstract";
  _exports.name = name;
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(13), __webpack_require__(77), __webpack_require__(78)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _hyperhtml, _inlineIdlParser, _renderBiblio) {
  "use strict";
  ...
  function _templateObject8() {
    const data = _taggedTemplateLiteral(["<a data-link-for=\"", "\" data-xref-for=\"", "\" data-lt=\"", "\">", "</a>"]);
  ...
  function inlineAnchorMatches(matched) {
    ...
    const [linkingText, text] = content.includes("|") ? content.split("|", 2).map(s => s.trim()) : [null, content];
    const processedContent = processInlineContent(text);
    const forContext = isFor ? (0, _utils.norm)(isFor) : null;
    return (0, _hyperhtml.default)(_templateObject8(), forContext, forContext, linkingText, processedContent);
  }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(80), __webpack_require__(9), __webpack_require__(3), __webpack_require__(78)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _biblioDb, _utils, _pubsubhub, _renderBiblio) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(81), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _idb, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports) {
  ...
  async function importIdb() {
    try {
      return await new Promise(resolve => Promise.resolve(/* AMD require */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(172)]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe));
    } catch (_unused) {
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(13), __webpack_require__(9), __webpack_require__(3), __webpack_require__(78), __webpack_require__(76)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _hyperhtml, _utils, _pubsubhub, _renderBiblio, _inlines) {
  "use strict";
  ...
  const name = "pcisig/pcisig-conformance";
  /**
  ...
  function run(conf) {
    ...
    (0, _pubsubhub.pub)("end", name);
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=pcisig-conformance.js.map
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports) {
  ...
  const name = "pcisig/pre-dfn";
  _exports.name = name;

  function run(conf, doc, cb) {
    "use strict";

    const dfnClass = ["dfn", "pin", "signal", "op", "opcode", "operation", "request", "response", "bit", "reply", "message", "msg", "command", "term", "field", "register", "regpict", "state", "value", "parameter", "argument"];
    ...
    cb();
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=pre-dfn.js.map
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(56)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _dfnMap) {
  ...
  function run() {
    document.querySelectorAll("dfn").forEach(dfn => {
      ...
      (0, _dfnMap.registerDefinition)(dfn, titles); // Default to `dfn` as the type... other modules may override

      if (!dfn.dataset.dfnType) dfn.dataset.dfnType = "dfn"; // Only add `lt`s that are different from the text content

      if (titles.length === 1 && titles[0] === (0, _utils.norm)(dfn.textContent)) {
        return;
      }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(86), __webpack_require__(9), __webpack_require__(56)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pluralize, _utils, _dfnMap) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(88), __webpack_require__(10), __webpack_require__(13), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _examples, _l10n, _hyperhtml, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(90), __webpack_require__(10), __webpack_require__(91), __webpack_require__(13), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _issuesNotes, _l10n, _githubApi, _hyperhtml, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3), __webpack_require__(93)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pubsubhub, _impnote) {
  "use strict";
  ...
  _exports.run = run;
  _exports.name = void 0;
  _impnote = _interopRequireDefault(_impnote);
  ...
  const name = "pcisig/impnote";
  _exports.name = name;

  function run(conf, doc, cb) {
    function handleIssues($ins) {
      $(doc).find("head link").first().before($("<style/>").text(_impnote.default));
      $ins.each(function (i, inno) {
        ...
        report.type = "impnote";
        var impnoteid = $inno.makeID("impnote", $inno.attr("title")); // wrap

        if (!isInline) {
          var $div = $("<div class='" + report.type + (isFeatureAtRisk ? " atrisk" : "") + "' id='" + impnoteid + "'></div>"),
    ...
    if ($ins.length) {
      ...
      cb();
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=impnote.js.map
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pubsubhub) {
  ...
  function run(conf, doc, cb) {
    ...
    $("table > caption").each(function () {
      ...
      num++;
      $cap.wrapInner($("<span class='tbl-title'/>")).prepend($("<span class='tbl-title-decoration'>&nbsp;</span>")).prepend($("<span class='tblno'>" + num + "</span>")).prepend($("<span class='tbl-tblno-decoration'>" + conf.l10n.tbl + "&nbsp;</span>"));
      ...
      tot.push($("<li class='totline'><a class='tocxref' href='#" + id + "'></a></li>").find(".tocxref").append($totCap.contents()).end());
  ...
  function run(conf, doc, cb) {
    ...
    $("figure.equation").each(function () {
      let $eqn = $(this),
          ...
          tit = $cap.text(),
          id = $eqn.makeID("eqn", tit); // set proper caption title

      num++;
      $cap.wrapInner($("<span class='eqn-title'/>")).prepend($("<span class='eqn-title-decoration'>&nbsp;</span>")).prepend($("<span class='eqnno'>" + num + "</span>")).prepend($("<span class='eqn-eqnno-decoration'>" + conf.l10n.eqn + "&nbsp;</span>"));
      ...
      toe.push($("<li class='toeline'><a class='tocxref' href='#" + id + "'></a></li>").find(".tocxref").append($toeCap.contents()).end());
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(100), __webpack_require__(132), __webpack_require__(9), __webpack_require__(133), __webpack_require__(13), __webpack_require__(56)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, webidl2, _dfnFinder, _utils, _webidl2, _hyperhtml, _dfnMap) {
  "use strict";
  ...
  function defineIdlName(escaped, data, parent) {
    ...
    if (!data.partial) {
      ...
      (0, _dfnMap.registerDefinition)(dfn, [name]);
      (0, _dfnFinder.decorateDfn)(dfn, data, parentName, name);
      return dfn;
    }
  ...
  function run() {
    ...
    for (const validation of validations) {
      let details = "<pre>".concat(validation.context, "</pre>");

      if (validation.autofix) {
        validation.autofix();
        details += "Try fixing as:\n      <pre>".concat(webidl2.write(astArray[validation.sourceName]), "</pre>");
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_webidl2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(101);
...
/* harmony import */ var _lib_writer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(130);
...
/* harmony import */ var _lib_validator_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(131);
...
/* harmony import */ var _lib_tokeniser_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(102);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parse", function() { return parse; });
/* harmony import */ var _tokeniser_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(102);
/* harmony import */ var _productions_enum_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(115);
/* harmony import */ var _productions_includes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(116);
/* harmony import */ var _productions_extended_attributes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(110);
/* harmony import */ var _productions_typedef_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(117);
/* harmony import */ var _productions_callback_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(118);
/* harmony import */ var _productions_interface_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(119);
/* harmony import */ var _productions_mixin_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(125);
/* harmony import */ var _productions_dictionary_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(126);
/* harmony import */ var _productions_namespace_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(128);
/* harmony import */ var _productions_callback_interface_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(129);
...
/* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(103);
/* harmony import */ var _productions_helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(104);
...
/* harmony import */ var _type_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105);
/* harmony import */ var _argument_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(108);
/* harmony import */ var _token_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(112);
/* harmony import */ var _extended_attributes_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(110);
/* harmony import */ var _operation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(113);
/* harmony import */ var _attribute_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(114);
/* harmony import */ var _tokeniser_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(102);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(104);
/* harmony import */ var _tokeniser_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(102);
/* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(103);
/* harmony import */ var _validators_helpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(107);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _default_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(109);
/* harmony import */ var _extended_attributes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(110);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(104);
/* harmony import */ var _tokeniser_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(102);
/* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(103);
/* harmony import */ var _validators_helpers_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(107);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _array_base_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(111);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(104);
/* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(103);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(104);
/* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(103);
...
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(104);
/* harmony import */ var _token_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(112);
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(106);
...
/* harmony import */ var _container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _attribute_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(114);
/* harmony import */ var _operation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(113);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(121);
/* harmony import */ var _iterable_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(122);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(104);
/* harmony import */ var _error_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(103);
/* harmony import */ var _validators_interface_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(123);
/* harmony import */ var _constructor_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(124);
/* harmony import */ var _tokeniser_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(102);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _extended_attributes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(110);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(104);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
/* harmony import */ var _type_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(105);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(104);
...
/* harmony import */ var _container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(121);
/* harmony import */ var _attribute_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(114);
/* harmony import */ var _operation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(113);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(104);
...
/* harmony import */ var _container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _field_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(127);
...
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(104);
/* harmony import */ var _extended_attributes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(110);
/* harmony import */ var _default_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(109);
...
/* harmony import */ var _container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _operation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(113);
/* harmony import */ var _constant_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(121);
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(56), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _dfnMap, _utils) {
  "use strict";
  ...
  function findNormalDfn(defn, parent, ...names) {
    for (const name of names) {
      ...
      if (dfns.length > 1) {
        const msg = "WebIDL identifier `".concat(name, "` ").concat(parent ? "for `".concat(parent, "`") : "", " is defined multiple times");
        (0, _utils.showInlineError)(dfns, msg, "Duplicate definition.");
      }
  ...
  function decorateDfn(dfn, defn, parent, name) {
    ...
    if (parent) dfn.dataset.dfnFor = parent; // Derive the data-type for dictionary members, interface attributes,
    // and methods
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(79), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _biblio, _utils) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(137), __webpack_require__(10), __webpack_require__(56), __webpack_require__(134), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _xref, _l10n, _dfnMap, _dataCite, _pubsubhub) {
  "use strict";
  ...
  const l10n = {
    en: {
       ...
       */
      duplicateMsg(title) {
        return "Duplicate definition(s) of '".concat(title, "'");
      },
  ...
  function mapTitleToDfns() {
    ...
    Object.keys(_dfnMap.definitionMap).forEach(title => {
      ...
      if (duplicates.length > 0) {
        (0, _utils.showInlineError)(duplicates, l10n[lang].duplicateMsg(title), l10n[lang].duplicateTitle);
      }
    });
    return titleToDfns;
  }
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(138), __webpack_require__(9), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _xrefDb, _utils, _pubsubhub) {
  "use strict";
  ...
  function showErrors({
    ...
    for (const {
      ...
      const msg = "Couldn't match \"**".concat(originalTerm, "**\" to anything in the document or in any other document cited in this specification: ").concat(specsString, ". ") + "See [how to cite to resolve the error](".concat(formUrl, ")");
    ...
    for (const {
      ...
      const originalTerm = getTermFromElement(elems[0]);
      const formUrl = getPrefilledFormURL(originalTerm, query, specs);
      const msg = "The term \"**".concat(originalTerm, "**\" is defined in ").concat(specsString, " in multiple ways, so it's ambiguous. ") + "See [how to cite to resolve the error](".concat(formUrl, ")");
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(137), __webpack_require__(9), __webpack_require__(81)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _xref, _utils, _idb) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(91), __webpack_require__(9), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _githubApi, _utils, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pubsubhub) {
  ...
  const name = "pcisig/fig-tbl-eqn-numbering";
  _exports.name = name;
  ...
  function run(conf, doc, cb) {
    if (conf.numberByChapter) {
      ...
      for (let i = 0; i < $secs.length; i++) {
        ...
        let first; // Process Figure Captions, populating figNumMap
    ...
    cb();
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=fig-tbl-eqn-numbering.js.map

/***/ }),
/* 145 */
/***/ (function(module, exports, __webpack_require__) {

var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(3), __webpack_require__(146), __webpack_require__(9), __webpack_require__(13)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _pubsubhub, _caniuse, _utils, _hyperhtml) {
  "use strict";
  ...
  function run(conf, doc, cb) {
    if (conf.addXrefMap) {
      ...
      if ($refs.length > 0) {
        ...
        $refs.each(function () {
          let number = $(".secno, .figno, .tblno, .eqnno", this).text().replace(/ /g, "&nbsp;").replace(/-/g, "&#8209;");
          let id = $(this).attr("href");
          let name = $(".sect-title, .fig-title, .tbl-title, .eqn-title", this).text();
          $("<tr><td>" + number + "</td>" + "<td class='long'>" + name + "</td>" + "<td class='long'><a href=\"" + id + "\">" + id.substr(1) + "</a></td></tr>").appendTo($tbody);
        });
      }
    }
    ...
    cb();
				...
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
//# sourceMappingURL=xref-map.js.map

/***/ }),
/* 148 */
/***/ (function(module, exports, __webpack_require__) {

var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(13), __webpack_require__(149)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _hyperhtml, _mdnAnnotation) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(10), __webpack_require__(13), __webpack_require__(3), __webpack_require__(151), __webpack_require__(11)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _l10n, _hyperhtml, _pubsubhub, _exporter, _ui) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(10), __webpack_require__(9), __webpack_require__(13), __webpack_require__(11), __webpack_require__(79)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_l10n, _utils, _hyperhtml, _ui, _biblio) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(158), __webpack_require__(13), __webpack_require__(9), __webpack_require__(159)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _github, _hyperhtml, _utils, _worker) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(9), __webpack_require__(4), __webpack_require__(160)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _utils, _exposeModules, _respecWorker) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(162)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _clipboard) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(166), __webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _var, _pubsubhub) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(168)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _datatype) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(170)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_exports, _algorithms) {
  "use strict";
...
/* harmony import */ var _chunk_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(173);
