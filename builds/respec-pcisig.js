...
(function (_pluralize) {
  ...
  _pluralize = _pluralize && _pluralize.hasOwnProperty('default') ? _pluralize['default'] : _pluralize;
  ...
  const modules = [
    ...
    Promise.resolve().then(function () { return pluralize$1; }),
  ...
  // @ts-check
  const name$v = "pcisig/pcisig-conformance";
  ...
  var pluralize$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    name: name$y,
    run: run$l
  });
...
${css}
  ...
  const name$Q = "core/mdn-annotation";
