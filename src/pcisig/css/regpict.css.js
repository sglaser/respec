...
g.regAttr_rsvd path.regFieldBox,
g.regAttr_rsvdp rect.regFieldBox,
g.regAttr_rsvdp path.regFieldBox,
g.regAttr_rsvdz rect.regFieldBox,
g.regAttr_rsvdz path.regFieldBox,
g.regAttr_reserved rect.regFieldBox,
g.regAttr_reserved path.regFieldBox,
g.regAttr_unused rect.regFieldBox,
g.regAttr_unused path.regFieldBox,
g.regFieldUnused rect.regFieldBox,
g.regFieldUnused path.regFieldBox {
  fill: #e8e8e8;
}
...
g.regFieldHidden path.regFieldBox,
...
svg *.svg_error text:not(.regBitWidth):not(.regBitNumMiddle):not(.regBitNumEnd):not(.regBitNumStart) {
    fill: red;
    font-size: 12pt;
    font-weight: bold;
    font-style: normal;
...
@media screen {
    ...
    g.regLink:hover path.regFieldBox,
    g.regLink:focus path.regFieldBox {
        fill: #ffa;
        stroke: blue;
        stroke-width: 2.5px;
    }
